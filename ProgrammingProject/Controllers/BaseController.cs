...
namespace ProgrammingProject.Controllers
{
    public class BaseController : Controller
    {
        ...
        public BaseController(EasyWalkContext context)
        {
            _context = context;

        }
        // Add code from helper to here now it is not needed in helper.
        //public void checkSuburbModelState(string suburbName, string postcode, string state)
        //{
        //    var checkModelState = new CheckModelState(_context);
        //    string suburbMatch = checkModelState.IsSuburbDataUnique(suburbName, postcode, state);

        //    if (!suburbMatch.Equals("Pass"))
        //    {
        //        if (suburbMatch.Equals("SuburbNameFail"))
        //            ModelState.AddModelError(nameof(suburbName), "Suburb Name does not exist in Australia");

        //        if (suburbMatch.Equals("PostcodeFail"))
        //            ModelState.AddModelError(nameof(postcode), "Postcode does not exist in Australia");

        //        if (suburbMatch.Equals("SuburbNamePostcodeFail"))
        //        {
        //            ModelState.AddModelError(nameof(suburbName), "There are no Suburbs with the Name and Postcode given");
        //            ModelState.AddModelError(nameof(postcode), "There are no Suburbs with the Name and Postcode given");
        //        }

        //        if (suburbMatch.Equals("Fail"))
        //        {
        //            ModelState.AddModelError(nameof(suburbName), "There are no Suburbs with the Name and Postcode given in this State/Territory");
        //            ModelState.AddModelError(nameof(postcode), "There are no Suburbs with the Name and Postcode given in this State/Territory");
